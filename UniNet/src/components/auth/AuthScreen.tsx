    ...
    <KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView ref={scrollRef} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.scroll}>
        <View style={styles.content}>
          ...
          {!compact && <View style={styles.brand}><View style={styles.brandMark}><Text style={styles.brandMarkText}>⬢</Text><Text style={styles.brandInner}>◇</Text></View><Text style={styles.brandName}>UniNet</Text></View>}
...
const styles = StyleSheet.create({
  ...
  brand: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 7, marginTop: 0, marginBottom: 25 }, brandMark: { width: 40, height: 40, alignItems: 'center', justifyContent: 'center' }, brandMarkText: { color: colors.primary, fontSize: 40, lineHeight: 43 }, brandInner: { position: 'absolute', color: colors.surface, fontSize: 23, fontWeight: '700' }, brandName: { color: colors.navy, fontSize: 26, fontWeight: '800', letterSpacing: -1 },
