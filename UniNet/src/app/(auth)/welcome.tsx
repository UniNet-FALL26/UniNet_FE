...
export default function WelcomeScreen() {
  return <SafeAreaView style={styles.safe} edges={['top', 'bottom']}>
    <View style={styles.top}><View style={styles.brand}><Text style={styles.logo}>⬢</Text><Text style={styles.brandText}>UniNet</Text></View><Pressable onPress={() => router.replace('/(auth)/login')} accessibilityRole="button" accessibilityLabel="Bỏ qua màn chào mừng" style={styles.skipTouch}><Text style={styles.skip}>Bỏ qua</Text></Pressable></View>
